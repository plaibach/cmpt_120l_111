...
//
   ...
   // Begin variables, class/prototypes, and array for locations
   ...
   // End variables, class/prototypes, and array for locations

   // Begin variables, class/prototypes, and array for items/inventory
   ...
   // End variables, class/prototypes, and array for items/inventory
...
//
   ...
   // Verify whether text is present when playe presses the enter key.
...
//
   ...
   function updateAllDisplays(playerAction, message) {
      ...
      // *************************************************** BEGIN TESTING
      // Since we are here, some form of valid button or user text command input has been processed, so enable text command "Go" button.
      // document.getElementById("btnTxtCommand").disabled = true;
      // *************************************************** END TESTING
